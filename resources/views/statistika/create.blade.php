                        ...
                        <div class="container flex justify-center">
                            <div class="justify-center ">
                                ...
                                <form action="/dataupdate" method="POST" enctype="multipart/form-data">
                                    ...
                                    <button type="submit"
                                        class="text-black bg-blue-500 hover:bg-blue-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Tambah</button>
                                </form>
                            </div>
                        </div>
                    </div>
